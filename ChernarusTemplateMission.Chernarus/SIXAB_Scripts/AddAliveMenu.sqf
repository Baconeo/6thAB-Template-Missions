		...
		[
			...
			[
				["6th AB Admin >",
					...
					"",
					"",
					["call SIXAB_Alive_addMenus", "submenu", 1],
					-1, 1, true
				]
			]
		]
...
// Menu actions.
["player", [SELF_INTERACTION_KEY], -9903, ["call SIXAB_Alive_addMenus;", "main"]] call ALIVE_fnc_flexiMenu_Add;
